...
var ChangePositionEvent = function (_createjs$Event) {
    _inherits(ChangePositionEvent, _createjs$Event);

    function ChangePositionEvent(type, v) {
        _classCallCheck(this, ChangePositionEvent);

        var _this = _possibleConstructorReturn(this, (ChangePositionEvent.__proto__ || Object.getPrototypeOf(ChangePositionEvent)).call(this));
...
exports.ChangePositionEvent = ChangePositionEvent;
...
},{"../coniferCone/geom/LineSegment":3,"../coniferCone/geom/Vector":5,"../coniferCone/util/Intersection":7,"./ui/UI_LineSegment":10,"./ui/UI_Point":11}],10:[function(require,module,exports){
"use strict";
...
var UI_LineSegment = function (_createjs$Container) {
    ...
    function UI_LineSegment(p1, p2) {
        ...
        _this.originalP1 = _this.p1.clone();
        _this.originalP2 = _this.p2.clone();
    ...
    _createClass(UI_LineSegment, [{
        ...
        value: function addEvent() {
            this.dotA.on(_Event.ChangePositionEvent.BEGIN, this.onBeginMove, this);
            this.dotA.on(_Event.ChangePositionEvent.ING, this.onMovingVertex, this);
            this.dotA.on(_Event.ChangePositionEvent.END, this.onMoveEndVertex, this);

            this.dotB.on(_Event.ChangePositionEvent.BEGIN, this.onBeginMove, this);
            this.dotB.on(_Event.ChangePositionEvent.ING, this.onMovingVertex, this);
            this.dotB.on(_Event.ChangePositionEvent.END, this.onMoveEndVertex, this);

            this.dotC.on(_Event.ChangePositionEvent.BEGIN, this.onBeginMove, this);
            this.dotC.on(_Event.ChangePositionEvent.ING, this.onMovingEdge, this);
            this.dotC.on(_Event.ChangePositionEvent.END, this.onMoveEndEdge, this);
        }
    }, {
        key: "setPosition",
        ...
        key: "onMovingVertex",
        value: function onMovingVertex(e) {
            this.moveVertex(e.target, e.v);
        }
    }, {
        key: "onMoveEndVertex",
        value: function onMoveEndVertex(e) {
            this.moveVertex(e.target, e.v);
        }
    }, {
        key: "moveVertex",
        value: function moveVertex(target, v) {

            if (target === this.dotA) {
                var p1 = _Vector.Vector.addVectors(this.originalP1, v);
                this.p1.x = p1.x;
                this.p1.y = p1.y;
            } else if (target === this.dotB) {
                var p2 = _Vector.Vector.addVectors(this.originalP2, v);
                this.p2.x = p2.x;
                this.p2.y = p2.y;
            }
        ...
        key: "onBeginMove",
        value: function onBeginMove() {
            this.originalP1 = this.p1.clone();
            this.originalP2 = this.p2.clone();
        }
    }, {
        key: "onMovingEdge",
        value: function onMovingEdge(e) {
            this.moveEdge(e.v);
        }
    }, {
        key: "onMoveEndEdge",
        value: function onMoveEndEdge(e) {
            this.moveEdge(e.v);
        }
    }, {
        key: "moveEdge",
        value: function moveEdge(v) {
            var p1 = _Vector.Vector.addVectors(this.originalP1, v);
            var p2 = _Vector.Vector.addVectors(this.originalP2, v);
            this.p1.x = p1.x;
            this.p1.y = p1.y;
...
},{"../../coniferCone/geom/Vector":5,"../event/Event":8,"./UI_Point":11}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.UI_Point = undefined;
...
var UI_Point = function (_createjs$Shape) {
    ...
    _createClass(UI_Point, [{
        ...
        value: function onMouseDown(e) {
            ...
            this.startP = new _Vector.Vector(e.stageX, e.stageY);
            this.originalP = this.p.clone();

            this.dispatchPositionEvent(_Event.ChangePositionEvent.BEGIN);
        }
    }, {
        key: "onMouseMove",
        value: function onMouseMove(e) {
            var moveP = new _Vector.Vector(e.stageX, e.stageY);
            var offsetP = _Vector.Vector.subVectors(moveP, this.startP);
            var p = _Vector.Vector.addVectors(this.originalP, offsetP);
            this.setPosition(p);

            this.dispatchPositionEvent(_Event.ChangePositionEvent.ING, offsetP);
        }
    }, {
        key: "onMouseUp",
        value: function onMouseUp(e) {
            ...
            this.dispatchPositionEvent(_Event.ChangePositionEvent.END, offsetP);
        }
        ...
        key: "dispatchPositionEvent",
        value: function dispatchPositionEvent(type, p) {
            var e = new _Event.ChangePositionEvent(type, p);
...
},{"../../coniferCone/geom/Vector":5,"../event/Event":8}]},{},[9])