...
var LineSegment = function (_Line) {
    ...
    function LineSegment(x1, y1, x2, y2) {
        ...
        _this.p1 = new _Vector.Vector2(x1, y1);
        _this.p2 = new _Vector.Vector2(x2, y2);
    ...
    _createClass(LineSegment, [{
        ...
        value: function isPointInLineSegment(x, y) {
            var p = new _Vector.Vector2(x, y);
            var p_p1 = _Vector.Vector2.subVectors(this.p1, p);
            var p_p2 = _Vector.Vector2.subVectors(this.p2, p);
        ...
        value: function toVector2() {
            return _Vector.Vector2.subVectors(this.p2, this.p1);
        }
    }, {
        key: "length",
        get: function get() {
            return new _Vector.Vector2().subVectors(this.p1, this.p2).length;
        }
    }]);
...
},{"./Line":2,"./Vector2":5}],4:[function(require,module,exports){
"use strict";
...
exports.Point = Point;
},{"../util/Distance":6,"./Vector2":5}],5:[function(require,module,exports){
'use strict';
...
var _Vector = require("../geom/Vector2");
...
var Intersection = function () {
    ...
    _createClass(Intersection, null, [{
        ...
        value: function lineSegmentToLineSegment(ls1, ls2) {
            ...
            var AB = _Vector.Vector2.subVectors(B, A);
            var AC = _Vector.Vector2.subVectors(C, A);
            var AD = _Vector.Vector2.subVectors(D, A);
            var CD = _Vector.Vector2.subVectors(D, C);
            var CA = _Vector.Vector2.subVectors(A, C);
            var CB = _Vector.Vector2.subVectors(B, C);
            ...
            if (ABXAC === 0 || ABXAD === 0 || CDXCA === 0 || CDXCB === 0) {
                ...
                if ((ABXAC ^ ABXAD) < 0 && (CDXCA ^ CDXCB) < 0) {
                    ...
                    console.log(n);
                    return _Vector.Vector2.lerpVectors(C, D, n / (1 + n));
                } else {
                    return null;
                }
            }
...
},{"../geom/Point":4,"../geom/Vector2":5}],8:[function(require,module,exports){
"use strict";

var _Edge = require("./ui/Edge");

var _Vector = require("../coniferCone/geom/Vector2");
...
var app = new Vue({
    el: "#app",
    data: {
        p1: new _Vector.Vector2(200, 150),
        p2: new _Vector.Vector2(300, 100),
        p3: new _Vector.Vector2(300, 100),
        p4: new _Vector.Vector2(300, 200)
    }
});
...
var edgeA = new _Edge.Edge(app.p1, app.p2);
var edgeB = new _Edge.Edge(app.p3, app.p4);
...
},{"../coniferCone/geom/LineSegment":3,"../coniferCone/geom/Vector2":5,"../coniferCone/util/Intersection":7,"./ui/Edge":10}],9:[function(require,module,exports){
'use strict';
...
var Dot = function (_createjs$Shape) {
    _inherits(Dot, _createjs$Shape);
...
var Edge = function (_createjs$Container) {
    ...
    function Edge(p1, p2) {
        ...
        _this.p1 = p1;
        _this.p2 = p2;
        _this.length = new _Vector.Vector2().subVectors(p2, p1).length;

        _this.dotA = new _Dot.Dot(p1);
        _this.dotB = new _Dot.Dot(p2);
        _this.line = new createjs.Shape();
        _this.dotC = new _Dot.Dot(new _Vector.Vector2(0, 0), 4);
    ...
    _createClass(Edge, [{
        ...
        key: "onEdgeDown",
        value: function onEdgeDown(e) {
            var onEdgeMoveId = this.stage.on('stagemousemove', onEdgeMove, this);
            var startP = new _Vector.Vector2(e.stageX, e.stageY);
            var originalP1 = this.p1.clone();
            var originalP2 = this.p2.clone();

            this.stage.on('stagemouseup', onEdgeUp, this, true);

            function onEdgeMove(e) {
                var moveP = new _Vector.Vector2(e.stageX, e.stageY);
                var offsetP = _Vector.Vector2.subVectors(moveP, startP);
                var newP1 = _Vector.Vector2.addVectors(originalP1, offsetP);
                var newP2 = _Vector.Vector2.addVectors(originalP2, offsetP);
                this.p1.copy(newP1);
                this.p2.copy(newP2);
        ...
        key: "onDotDown",
        value: function onDotDown(e, target) {
            var onDotMoveId = void 0;
            var onDotup = function onDotup() {
                this.stage.off('stagemousemove', onDotMoveId);
            };
            var onDotMove = function onDotMove(e, data) {
                var moveP = _Vector.Vector2.subVectors(new _Vector.Vector2(e.stageX, e.stageY), data.fixedP);
            ...
            var _ref = target === this.p1 ? [this.p2, this.p1] : [this.p1, this.p2],
        ...
        value: function setPosition() {
            var center = _Vector.Vector2.lerpVectors(this.p2, this.p1, 0.5);

            this.x = center.x;
            this.y = center.y;
            this.dotA.setPosition(_Vector.Vector2.subVectors(this.p1, center));
            this.dotB.setPosition(_Vector.Vector2.subVectors(this.p2, center));
        }
    }, {
        key: "drawLine",
...
exports.Edge = Edge;
},{"../../coniferCone/geom/Vector2":5,"./Dot":9}]},{},[8])